PACKAGE BODY "PKG_MEM_XMAS_KIOSK" AS											
...
****************************************************************************************************/											
	...
	#ERROR!										
	-----------------------------------------------------------------------------------------------------------------------										
	PROCEDURE GET_VALID_USER(ARG_PATRON_NO   IN CMS.T_PATRON_CARD_ISSUE.FST_INS_USER_ID%TYPE,										
	...
	#ERROR!										
	-----------------------------------------------------------------------------------------------------------------------										
	PROCEDURE GET_EVENT_NUM(ARG_PATRON_NO   IN CMS.T_PATRON_CARD_ISSUE.FST_INS_USER_ID%TYPE,										
							ARG_REMOTE_ADDR IN VARCHAR2,				
	...
	#ERROR!										
	-----------------------------------------------------------------------------------------------------------------------										
	PROCEDURE SET_PATRON_PRINT(ARG_PATRON_NO   IN CMS.T_PATRON_CARD_ISSUE.FST_INS_USER_ID%TYPE,										
							   ARG_REMOTE_ADDR IN VARCHAR2,  				
							   ARG_DM_START_NO IN CMS.T_FREE_COUPON_OUT.DM_START_NO%TYPE)				
	IS 										
		V_TEAM_CD        VARCHAR2(4);									
	    V_PURPOSE_CD     VARCHAR2(5);										
		USER_DEF_EXP EXCEPTION;									
	...
	#ERROR!										
	-----------------------------------------------------------------------------------------------------------------------										
	PROCEDURE GET_PRIZE_REPRINT(ARG_PATRON_NO   IN CMS.T_PATRON_CARD_ISSUE.FST_INS_USER_ID%TYPE,										
								ARG_REMOTE_ADDR IN VARCHAR2,			
								RC_INFO         OUT SYS_REFCURSOR)			
	IS 										
		V_TEAM_CD        VARCHAR2(4);									
